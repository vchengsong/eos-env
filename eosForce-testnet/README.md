...
private_key=5JAQwHBwzNj6y8nogZSdTw1M5GfrLJhp8avFbWUPr3E8oPnZvcD
public_key=EOS7pBE74eNFfTxkE3yXCHbDwVMzPUDYcYiRzpBDN6pjVvNtX5QF5

faucet_private_key=5KBewcMCkmEF5MkUGaF7ZP9twe5ZyhPE7kEKbVvDytieMwDwCR4
faucet_public_key=EOS5M5hGULQnq7PhANmw54Su1QD8FJR84Xe3pg3UpEJLwa85TTmhY

docker run --rm  --name nodeos \
    -p 8888:8888 -p 9876:9876 \
    -v /data/eos/data:/opt/eosio/bin/data-dir \
    -v /data/eos/blockchain:/root/.local/share/eosio/nodeos/data \
    eosforce/eos:20180430 nodeos \
    --enable-stale-production \
    --producer-name eostore --resync\
    --plugin eosio::chain_api_plugin \
    --plugin eosio::http_plugin \
    --plugin eosio::producer_plugin \
    --plugin eosio::account_history_api_plugin \
    --p2p-peer-address eosio.eosforce.io:9876 \
    --p2p-peer-address ortc.io:9876 \
    --p2p-peer-address 45.77.170.82:9876 \
    --http-server-address 0.0.0.0:8888 \
    --agent-name "eos.store" \
    --faucet-private-key [\"${faucet_public_key}\",\"${faucet_private_key}\"] \
    --private-key [\"${public_key}\",\"${private_key}\"]

docker logs -f --tail 1 nodeos

cleos create account eosio eostore EOS7pBE74eNFfTxkE3yXCHbDwVMzPUDYcYiRzpBDN6pjVvNtX5QF5 EOS7pBE74eNFfTxkE3yXCHbDwVMzPUDYcYiRzpBDN6pjVvNtX5QF5

cleos push action eosio regproducer '{"producer": "eos.store","producer_key": "EOS7pBE74eNFfTxkE3yXCHbDwVMzPUDYcYiRzpBDN6pjVvNtX5QF5"}' -p eos.store
